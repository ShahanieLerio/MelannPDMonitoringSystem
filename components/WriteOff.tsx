              ...
              <tr key={row.disposition.id} className="group transition-colors hover:bg-slate-50/80 dark:hover:bg-slate-800/50">
                ...
                <td className="px-3 py-3 whitespace-normal">
                  ...
                  {row.disposition.evidence && row.disposition.evidence.length > 0 && (
                    <div className="mt-1.5 inline-flex items-center gap-1 rounded-md bg-amber-50 px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider text-amber-700 border border-amber-200/50 dark:bg-amber-900/20 dark:border-amber-900/50 dark:text-amber-400">
