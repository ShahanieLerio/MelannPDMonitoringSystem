...
export const COLORS = {
  primary: '#1e293b', // Dark Teal/Blue from logo
  secondary: '#15803d', // Green from logo
  accent: '#eab308', // Yellow from logo
  danger: '#dc2626', // Red from bars
  success: '#16a34a',
  info: '#2563eb',
};
...
export const STATUS_COLORS: Record<string, string> = {
  ...
  'NM': 'bg-red-100 text-red-800',
  'NMSR': 'bg-amber-100 text-amber-800',
  'L': 'bg-green-100 text-green-800',
  'NL': 'bg-slate-100 text-slate-800',
};

export const formatReportedMonth = (val: string) => {
